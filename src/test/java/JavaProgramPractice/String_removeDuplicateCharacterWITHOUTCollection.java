...
//remove duplicate character from a string WITHOUT Collection
class String_removeDuplicateCharacterWITHOUTCollection {
...
//remove duplicate character from a string WITH Collection
